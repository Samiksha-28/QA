...
### Core Expertise
* Automation Testing: Selenium WebDriver (Java), TestNG, Cucumber BDD
* API Testing: Postman, Rest Assured
* Performance Testing: Apache JMeter
* Manual Testing: Functional, Regression, Sanity, Exploratory
* Tools: JIRA, Eclipse, Maven, Git
* Databases: MySQL, MongoDB, DynamoDB (data validation & queries)
...
## Languages:
Java | SQL | JavaScript | Python | Gherkin

## Testing Tools:
Selenium | Postman | JMeter | Cucumber
